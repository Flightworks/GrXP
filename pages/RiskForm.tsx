...
const RiskForm: React.FC<RiskFormProps> = ({ riskId, onNavigate }) => {
  ...
  const residualRiskColor = getRiskColor(risk.residualRisk.computedLevel);
    ...
    <div className="max-w-4xl mx-auto pb-24">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-slate-200 p-4 md:pl-20 shadow-[0_-5px_15px_-5px_rgba(0,0,0,0.1)]">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
             ...
             <div className={`px-4 py-1.5 rounded-lg text-xs md:text-sm font-black uppercase tracking-wider text-white shadow-md ${residualRiskColor.split(' ')[0]}`}>
