      ...
      <svg className="w-full h-full overflow-visible" viewBox="0 0 100 100" preserveAspectRatio="none">
        <defs>
          <marker id="arrowhead" markerWidth="5" markerHeight="5" refX="2.5" refY="2.5" orient="auto">
             <path d="M0,0 L0,5 L5,2.5 z" fill="#84cc16" />
          </marker>
           <marker id="arrowstart" markerWidth="4" markerHeight="4" refX="2" refY="2" orient="auto">
            <circle cx="2" cy="2" r="1.5" fill="#84cc16" />
          </marker>
          <filter id="glow">
    ...
    <div className="flex flex-col items-center select-none w-full max-w-sm mx-auto">
        ...
        <div className="relative p-6 bg-slate-100 rounded-3xl shadow-inner mx-auto">
            ...
            <div className="flex flex-col relative">
                 {/* The Arrow Layer */}
                 {/* positioned to skip the left header (left-8) and top header (top-6) to align with cells */}
                 <div className="absolute inset-0 left-8 top-6 z-20 pointer-events-none">
