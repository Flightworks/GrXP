            ...
            {/* Matrix Legend */}
             <div className="mt-6 grid grid-cols-4 gap-2 w-full max-w-[280px]">
                 {['Usuel', 'Faible', 'Fort', 'Inacceptable'].map((lvl) => {
                    const color = getRiskColor(lvl as any).split(' ')[0];
                    return (
             ...
             <div className="flex-1 overflow-y-auto max-h-[500px] pr-2 custom-scrollbar space-y-3">
                 {sortedRisks.length > 0 ? (
                     sortedRisks.map(risk => {
                         const residualColor = getRiskColor(risk.residualRisk.computedLevel);
                         ...
                         return (
                            ...
                            >
                                ...
                                <div className={`absolute left-0 top-0 bottom-0 w-1.5 ${residualColor.split(' ')[0]}`}></div>
                                ...
                                <div className="pl-3">
                                    ...
                                    <div className="flex justify-between items-start mb-2">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className={`text-[10px] font-black uppercase px-2 py-0.5 rounded ${residualColor}`}>
